...
const Dropdown = ({ data, setCurrentCb, setData, sortCb, displayCb }) => {
    ...
    return (
        <div className='hover:cursor-pointer my-2'>
            <div className='flex items-center gap-3 w-full max-w-[200px] bg-white text-black p-3 rounded' onClick={() => onClickCurrent(first)}>
                <p> {displayCb(first)} </p>
            ...
            {isVisible &&
                <ul className='bg-white p-3 rounded absolute w-full max-w-[200px] mt-1'>
