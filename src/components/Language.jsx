    ...
    return (
        <div
            ...
            className={`
                ...
                rounded-3xl bg-white bg-opacity-30 shadow-black shadow-sm hover:cursor-pointer ${!isCurrent && !display ? 'absolute opacity-0' : ''}
                ${display ? `absolute opacity-1` : ''}
                `}
        >
            <img className='w-6 h-6 rounded-2xl mr-1' src={flag} alt='flag' />
            {isCurrent ?
