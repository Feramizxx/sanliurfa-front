...
const Language = ({language,isCurrent,isVisible,onClick}) => {
    return (
        ...
        `} onClick={onClick}>
            <img className='w-6 h-6 rounded-2xl mr-1' src={language === 'aze'? require('../assets/img/az-flag.png') : 'https://upload.wikimedia.org/wikipedia/commons/1/13/United-kingdom_flag_icon_round.svg'} alt=""/>
            {isCurrent?
