...
const Footer = () => {
    return (
        <footer className='bg-primary-bg text-white font-Roboto'>
            <section className='flex py-9 justify-evenly'>
                ...
                <div>
                    ...
                    <ul>
                        <li className='footer-list-item'> <a href="#"> +994123714939 </a> </li>
                        <li className='footer-list-item'> <a href="#"> office@sanliurfa.az </a> </li>
                        <li className='footer-list-item'> <a href="#"> M.Hadi 23/24, Həzi Aslanov </a> </li>
                    </ul>
                </div>
                <div>
                    ...
                    <div className='flex my-4'>
                        <SocialMediaLink className={'mr-2'} href={'#'}>
                            <svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.04074 15.2138V7.93153H0.535156V5.42192H2.04074V3.91516C2.04074 1.86782 2.89088 0.650391 5.30624 0.650391H7.3171V3.16029H6.06017C5.11993 3.16029 5.05773 3.51101 5.05773 4.16555L5.05431 5.42164H7.33133L7.06489 7.93125H5.05431V15.2138H2.04074Z" fill="white"/>
                            </svg>
                        </SocialMediaLink>
                        <SocialMediaLink className={'mr-2'} href={'#'}>
                            <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.99078 14.2429H0.078125V5.50488H2.99078V14.2429V14.2429Z" fill="white"/>
                                <path d="M1.52579 3.56311H1.50925C0.640047 3.56311 0.078125 2.91554 0.078125 2.10625C0.078125 1.27984 0.657162 0.650391 1.54286 0.650391C2.42855 0.650391 2.97398 1.27984 2.99078 2.10625C2.99078 2.91554 2.42855 3.56311 1.52579 3.56311V3.56311Z" fill="white"/>
