        ...
        <nav className='flex justify-around items-center z-10 bg-navbarBackground backdrop-blur-[72px]'>
            ...
            <ul
                className={`
                    ...
                    min-md:static min-md:flex min-md:h-0 min-md:bg-inherit min-md:z-0 min-md:p-0 min-md:justify-evenly min-md:items-center min-lg:w-[60vw]
                `}
            >
            ...
            <LanguagePicker/>
            <svg onClick={onMenuClick} className="fill-primary-bg hover:cursor-pointer min-md:hidden" width="48" height="32" viewBox="0 0 48 32"
            ...
            <svg style={{display: isMenuOpen? 'block' : 'none'}}
                onClick={onMenuClick} className="fill-primary-bg hover:cursor-pointer fixed right-0 top-0 m-3 z-50 close-button-appear min-md:hidden" width="33" height="33" viewBox="0 0 33 33" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
