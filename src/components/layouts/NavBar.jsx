        ...
        <nav className='flex justify-around items-center z-10 bg-navbarBackground backdrop-blur-[72px]'>
            ...
            <ul className={'flex justify-between items-center'}>
                ...
                <NavLink
                    ...
                    onClick={() => onLinkClick()}
                >
                    <button className='navbar-icon relative'>
                        ...
                        {totalAmount !== 0 &&
                            <div className="bg-red rounded-full h-[20px] w-[20px] flex items-center justify-center text-xs text-white absolute -right-2 -bottom-3" >
                                {totalAmount}
                            </div>
                        }
                    </button>
