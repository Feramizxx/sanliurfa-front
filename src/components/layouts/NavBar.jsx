    ...
    return (
        <nav className='flex justify-around items-center z-10 bg-navbarBackground backdrop-blur-[72px]'>
            ...
            <svg style={{display: isMenuOpen? 'block' : 'none'}}
                onClick={onMenuClick} className="fill-primary-bg hover:cursor-pointer fixed right-0 top-0 m-3 z-50 close-button-appear md:hidden" width="33" height="33" viewBox="0 0 33 33" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
