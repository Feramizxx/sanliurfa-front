        ...
        <nav className='flex justify-around items-center z-10 bg-navbarBackground backdrop-blur-[72px]'>
            ...
            <ul
                className={`
                    ...
                    md:static md:flex md:h-0 md:bg-inherit md:z-0 md:p-0 md:justify-evenly md:items-center lg:w-[60vw]
                `}
            >
            ...
            <LanguagePicker/>
            {!isMenuOpen?
                <svg onClick={onMenuClick} className="fill-primary-bg hover:cursor-pointer md:hidden" width="48" height="32" viewBox="0 0 48 32"
                   xmlns="http://www.w3.org/2000/svg">
                    <path d="M24 32H0V26.6667H24V32ZM48 18.6667H0V13.3333H48V18.6667ZM48 5.33333H24V0H48V5.33333Z"/>
                </svg> :
                <svg onClick={onMenuClick} className="fill-primary-bg hover:cursor-pointer fixed right-0 top-0 m-3 z-50 close-button-appear md:hidden" width="33" height="33" viewBox="0 0 33 33" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
