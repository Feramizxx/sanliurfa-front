    ...
    <section className="kids-section m-0  p-0">
      <div className="h-96 bg-cover relative bg-center  ">
        <div className="flex w-full h-full pt-10 pl-10  flex-col items-start  justify-around   " >
          <h1 className="text-white xl:w-full w-3/5 lg:text-[32px] sm:text-[20px] text-5xl">
            Doğmalarla birgə keçirilən gün yaddaşlarınıza xüsusi həkk olunur
          </h1>
          <p className="text-white  lg:text-[16px]  text-xl xl:w-full w-1/2  ">
          ...
          <button className="text-red font-bold lg:mt-0 mt-7  bg-white rounded-xl px-10 py-1">Ətraflı</button>
        </div> 
      </div>


      <div className="h-96 bg-cover relative bg-center ">
        <div className="flex w-full h-full pt-10 px-10  flex-col items-end  justify-around   " >
          <h1 className="text-white xl:w-full w-3/5 lg:text-[32px] sm:text-[20px] text-5xl">
