...
const InlineNews = () => {
  return (
    // <div className="pb-12 pt-[150px] news-container flex flex-row bg-red ">
    ...
    <div className="pb-[150px]  pt-[150px] news-container flex flex-row lg:flex-col bg-red ">
      ...
      <div  className="ml-[75px] lg:w-[100%]  lg:ml-0 mt-[100px] ">
        ...
        <div id="news-grid" className="mt-4 grid lg:grid-cols-3 md:grid-cols-2 place-items-center gap-x-2 lg:gap-y-2 gap-y-5">
